...
function stp_getBibleLessonSubjects( $weeks_to_display = 3, $display_more_info_link = '0', $thanksgiving_days_in_advance = 30 ) {
	...
	if ('1' == $display_more_info_link) {
		$output .= __('<li class="stp_cs_bible_lesson_topics_more_info_link"><a href="http://biblelesson.christianscience.com" target="_blank">More info about the Bible Lesson &raquo;</a></li>', 'christian-science-bible-lesson-subjects');
	}
...
?>
		...
		<?php _e('<a href="http://biblelesson.christianscience.com" target="_blank">More info about the Bible Lesson</a></p>', 'christian-science-bible-lesson-subjects'); ?>
