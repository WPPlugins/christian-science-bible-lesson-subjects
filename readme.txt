...
Display upcoming Christian Science Bible Lesson topics in any widget area on your site.  Also includes shortcode and Spanish translation.

= Widget Features: =

* Select number of upcoming subjects to display (default is 3 weeks)
* Select whether to display 'more info' link to [ChristianScience.com](http://biblelesson.christianscience.com "More information about Bible Lessons at ChristianScience.com")
